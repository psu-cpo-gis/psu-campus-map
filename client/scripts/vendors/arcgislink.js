 ...
 * @private
 * @param {Object} extent
 * @return {google.maps.LatLngBounds} google.maps.LatLngBounds
 */
...
function LambertConformalConic(params) {
    ...
    //for NCSP83: google.maps.LatLng(35.102363,-80.5666)<  === > GPoint(1531463.95, 495879.744);
    params = params || {};
  SpatialReference.call(this, params);
...
function TransverseMercator(params) {
    params = params || {};
  SpatialReference.call(this, params);
    //google.maps.LatLng(33.74561,-84.454308)<  === >  GPoint(2209149.07977075, 1362617.71496891);
 ...
 * @property {Array.OverlayView|Array.object} [geometries] Array of <code>google.maps.LatLng, Polyline, Polygon</code>, or ESRI Geometry format to project.
  ...
  */
  ...
  MapOverlay.prototype.show = function () {
    ...
    console.log('overlay', this.overlay_);
